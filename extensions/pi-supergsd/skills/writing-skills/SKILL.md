...
|-------------|----------------|
| **Test case** | Pressure scenario with agent behavior |
...
Use words an LLM would search for:
...
**IMPORTANT: Use a todo list to create todos for EACH checklist item below.**

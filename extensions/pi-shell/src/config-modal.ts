...
function buildInspectorSettings(config: ShellConfig): InspectorSettingItem[] {
  ...
  return [
    ...
    },
    {
      ...
      values: ON_OFF,
      inspectorTitle: "Git Status",
      inspectorSummary: ["Shows the current git branch and changed line counts on the right side of the footer."],
      inspectorOptions: ["on — show the git branch and line counts", "off — hide git status"],
      inspectorPath: configPath,
